<header class="banner px-2 py-1">
<nav class="navbar navbar-light navbar-expand-md  justify-content-center">
    <div class="container-fluid">
      <a class="brand" href="{{ home_url('/') }} "><img src="@asset('images/matko-antolcic-logo-64.png')" width="64" alt="logo" class="pr-2"/>{{ get_bloginfo('name', 'display') }}</a>
    ...
    <button class="navbar-toggler third-button" type="button" data-toggle="collapse" data-target="#collapsingNavbar2"
      ...
      <div class="navbar-collapse nav-primary collapse justify-content-between align-items-center" id="collapsingNavbar2">
        @if (has_nav_menu('primary_navigation'))
          {!! wp_nav_menu($primarymenu) !!}
        @endif
        <ul class="nav navbar-nav flex-row justify-content-center flex-nowrap language-select">
